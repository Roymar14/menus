                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control" placeholder="Nama Lengkap" name="name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="last-name-column" class="form-control" placeholder="Nomor Telepon" name="telp" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="" class="form-control" placeholder="Alamat Email" name="password" required>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('admin.users.destroy', $user->id) }}" method="POST">
                                                                        @csrf
                                                    <a href="http://" class="btn btn-success">Detail</a>
